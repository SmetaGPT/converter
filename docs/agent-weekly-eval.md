...
| Signal | Score | Basis |
| --- | ---: | --- |
| Validation discipline | 5/5 | 61/61 telemetry entries have pass-like validation results. |
| State hygiene | 5/5 | 61/61 telemetry entries report state_update=true. |
| Feature traceability | 5/5 | 61/61 telemetry entries reference at least one feature_id. |
