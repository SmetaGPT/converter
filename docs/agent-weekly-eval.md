...
- telemetry entries in window: `38`;
- state updates in window: `38`;
- feature-traceable entries in window: `38`;
...
| Signal | Score | Basis |
| --- | ---: | --- |
| Validation discipline | 5/5 | 38/38 telemetry entries have pass-like validation results. |
| State hygiene | 5/5 | 38/38 telemetry entries report state_update=true. |
| Feature traceability | 5/5 | 38/38 telemetry entries reference at least one feature_id. |
