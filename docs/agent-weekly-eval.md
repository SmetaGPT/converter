...
Дата среза: 2026-05-24
Окно: 2026-05-18 .. 2026-05-24 (7 дней)
Статус: strong
...
- telemetry entries in window: `36`;
- state updates in window: `36`;
- feature-traceable entries in window: `36`;
- validated features in spine: `25`;
- referenced features in telemetry: `25`.

## 2. Observed signals

| Signal | Score | Basis |
| --- | ---: | --- |
| Validation discipline | 5/5 | 36/36 telemetry entries have pass-like validation results. |
| State hygiene | 5/5 | 36/36 telemetry entries report state_update=true. |
| Feature traceability | 5/5 | 36/36 telemetry entries reference at least one feature_id. |
| Feature coverage in telemetry | 5/5 | 25/25 validated features are referenced by structured telemetry. |
